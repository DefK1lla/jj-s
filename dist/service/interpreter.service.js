...
function createInterpreter(user_id, name, recent_translated, scored_text) {
    return __awaiter(this, void 0, void 0, function () {
        var isDataExist, interpreter, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    isDataExist = interpreter_model_1.Interpreter.findOne({ user_id: user_id });
                    if (isDataExist === null) {
                        return [2 /*return*/, new Error('Interpreter exist and it have to be unique')];
                    }
                    interpreter = new interpreter_model_1.Interpreter({
                        user_id: user_id,
                        name: name,
                        recent_translated: recent_translated,
                        scored_text: scored_text,
                    });
                    return [4 /*yield*/, interpreter.save()];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, interpreter_model_1.Interpreter.findOneAndUpdate({ user_id: user_id }, {
                            name: name,
                            recent_translated: recent_translated,
                            scored_text: scored_text
                        })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, interpreter_model_1.Interpreter.findOne({ user_id: user_id })];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    e_3 = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, interpreter_model_1.Interpreter.findByIdAndDelete(id)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    e_4 = _a.sent();
