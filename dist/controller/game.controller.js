    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, game_service_1.createGame)(req.body.author_id, req.body.name, req.body.img)];
                case 1:
                    _a.sent();
                    res.status(200);
                    res.end();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    _b = (_a = res).send;
                    return [4 /*yield*/, (0, game_service_1.getGameById)(req.body.id)];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 3];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    _b = (_a = res).send;
                    return [4 /*yield*/, (0, game_service_1.getGames)()];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 3];
                case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, game_service_1.updateGame)(req.body.id, req.body.name, req.body.img)];
                case 1:
                    _a.sent();
                    res.status(200);
                    res.end();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, game_service_1.deleteGame)(req.body.id)];
                case 1:
                    _a.sent();
                    res.status(200);
                    res.end();
