...
export const createChildFileData = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const findChildFileData = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const updateFileData = async (
  ...
  try {
    await updateFile(req.body.id, req.body.name, req.body.local, req.body.data);
    res.status(200);
    res.end();
  } catch (e: any) {
    res.status(503);
...
export const updateChildFileData = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const deleteFileDataById = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const deleteChildFileDataById = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
